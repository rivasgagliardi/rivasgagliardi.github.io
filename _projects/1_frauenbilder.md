...
description: Universität zu Köln, seit 2024
importance: 1
category: Aktuell
---
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (container && toggler) {
    ...
    langDiv.innerHTML = '<a href="/projects/1_frauenbilder/" class="active">DE</a> · <a href="/pt/projects/frauenbilder/">PT</a> · <a href="/en/projects/frauenbilder/">EN</a>';
