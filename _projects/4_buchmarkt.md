...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (container && toggler) {
    ...
    langDiv.innerHTML = '<a href="/projects/4_buchmarkt/" class="active">DE</a> · <a href="/pt/projects/buchmarkt/">PT</a> · <a href="/en/projects/buchmarkt/">EN</a>';
...
- [Contrasts in the Brazilian Book Market at the Beginning of the 21st Century](/publications/#gagliardi2022contrasts)
