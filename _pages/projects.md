...
<h2 class="section-label">Habilitationsprojekt</h2>
...
<h2 class="section-label">Forschungsprojekte</h2>
<div class="projects-grid">
  <div class="card">
    <a href="/projects/2_dfg/"><h3>Neuperspektivierungen nachkolonialer Theorie</h3></a>
    <p>Universität zu Köln, 2021–2024 · Gefördert von der DFG (Eigene Stelle) · <a href="https://gepris.dfg.de/gepris/projekt/459579268">GEPRIS</a></p>
  </div>
  <div class="card">
    <a href="/projects/3_wolf/"><h3>Le Brésil littéraire (1863) von Ferdinand Wolf</h3></a>
    <p>Freie Universität Berlin, 2014–2019 · Stipendiatin der Friedrich Schlegel Graduate School of Literary Studies</p>
  </div>
</div>
<h2 class="section-label">Frühere Qualifikationsarbeiten</h2>
<div class="projects-grid">
  <div class="card">
  ...
  <div class="card">
    ...
    <p>Universidade de São Paulo, 2002–2006 · Gefördert von der FAPESP (São Paulo Research Foundation) im Rahmen der Iniciação Científica, eines kompetitiven brasilianischen Programms, das eigenständige Forschung bereits im Grundstudium fördert</p>
  </div>
</div>
